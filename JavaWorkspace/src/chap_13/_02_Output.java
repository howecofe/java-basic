...
//        System.out.printf();
        ...
        System.out.printf("%d%n", 1); // %n : OS 가리지 않고 줄바꿈
        ...
        System.out.printf("%-6d%n", 1234); // 1234__ (6자리의 공간을 확보하고 나서 왼쪽 정렬 12344 출력)

        System.out.println("-------- 실수 --------");
        System.out.printf("%f%n", Math.PI); // 3.141593 (일반 출력)
        System.out.printf("%.2f%n", Math.PI); // 3.14 (소수점 둘쨰자리)
        System.out.printf("%6.2f%n", Math.PI); // __3.14 (6자리 공간 확보하고 소수점 둘쨰자리)
        ...
        System.out.printf("%-6s%n", "Java"); // Java__ (6자리 공간 확보하고 왼쪽 정렬)
        ...
        System.out.println("이름      영어   수학    평균"); // 공백이 각각 6, 3, 4 칸으로 구분
